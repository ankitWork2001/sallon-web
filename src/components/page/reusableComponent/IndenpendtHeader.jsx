...
const IndenpendtHeader = (props) => {
  return (
    <div>
        <div>
                  <header className="px-6 py-6 border-b text-white" style={{ background: "var(--pink-gradient)" }}>
                  ...
                  <nav className="px-6 py-4">
                      <div className="grid grid-cols-3 gap-4">
                          <div className="flex items-center gap-3">
                              <div className={`flex items-center justify-center w-10 h-10 rounded-full  text-white text-xl ${props.green ? 'bg-green-400' : 'bg-pink-600'}`}>
                          ...
                          <div className="flex items-center gap-3">
                              <div className={`flex items-center justify-center w-10 h-10 rounded-full   text-xl ${props.green2 ? 'bg-green-400 text-white' : 'bg-gray-200 text-pink-600'}`}>
                          ...
                          <div className="flex items-center gap-3">
                              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 text-xl">
                                  <MdVerifiedUser className='text-pink-600' />
                              </div>
                              <div>
